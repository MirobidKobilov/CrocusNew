                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="single-tour-inner">
                                    ...
                                    <div class="tab-content" id="myTabContent">
                                        ...
                                        <div class="tab-pane" id="program" role="tabpanel"
                                            ...
                                            <div class="itinerary-content">
                                                ...
                                                <p>Dolores maiores dicta dolore. Natoque placeat libero sunt sagittis
                                                ...
                                                <ul>
                                                    <li>
                                                        <div class="timeline-content">
                                                            ...
                                                            <p>Nostra semper ultricies eu leo eros orci porta provident,
                                                                fugit? Pariatur interdum assumenda, qui aliquip ipsa!
                                                                Dictum natus potenti pretium.</p>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div class="timeline-content">
                                        ...
                                        <div class="tab-pane" id="review" role="tabpanel"
                                            ...
                                            <div class="summary-review">
                                                ...
                                                <div class="review-score-content">
                                                    ...
                                                    <p>Tincidunt iaculis pede mus lobortis hendrerit eveniet impedit
                                                        aenean mauris qui, pharetra rem doloremque laboris euismod
                                                        deserunt non, cupiditate, vestibulum.</p>
                                                </div>
                                            </div>
                                            <!-- review comment html -->
                                                            ...
                                                            <ol>
                                                                <li>
                                                                    ...
                                                                    <div class="comment-content">
                                                                        ...
                                                                        <p>Officia amet posuere voluptates, mollit
                                ...
                                <a href="/{{ app()->getLocale() }}/book-now" class="button-primary">
                                    Bron qilish
                                </a>
                            ...
                            <div class="sidebar">
                                ...
                                <div class="widget-bg information-content text-center">
                                    ...
                                    <p>Mollit voluptatem perspiciatis convallis elementum corporis quo veritatis aliquid
                                        blandit, blandit torquent, odit placeat. </p>
                                ...
                                {{-- <div class="travel-package-content text-center"
                                    ...
                                    <ul>
                                        <li>
                                            <a href="#"><i class="far fa-arrow-alt-circle-right"></i>Vacation
                                                packages</a>
                                        </li>
                                        <li>
                                            <a href="#"><i class="far fa-arrow-alt-circle-right"></i>Honeymoon
                                                packages</a>
                                        </li>
                                        <li>
                                            <a href="#"><i class="far fa-arrow-alt-circle-right"></i>New year
                                                packages</a>
                                        </li>
                                        <li>
                                            <a href="#"><i class="far fa-arrow-alt-circle-right"></i>Weekend
                                                packages</a>
                                        </li>
                                    </ul>
                                </div> --}}
