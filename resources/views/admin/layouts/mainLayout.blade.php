...
<head>
    ...
    <title>Crocus | Travel & Tour</title>
</head>
...
<body>
        ...
        <div id="dashboard" class="dashboard-container">
            <div class="dashboard-header sticky-header">
                <div class="content-left  logo-section pull-left">
                    <h1><a href="../index.html"><img src="/admin/images/logo.png" alt=""></a></h1>
                </div>
                        ...
                        <div class="dropdown-menu notification-menu" aria-labelledby="notifyDropdown">
                            ...
                            <ul>
                                <li>
                                    <a href="#">
                                        <div class="list-img">
                                            <img src="/admin/images/comment.jpg" alt="">
                                        </div>
                                ...
                                <li>
                                    <a href="#">
                                        <div class="list-img">
                                            <img src="/admin/images/comment2.jpg" alt="">
                                        </div>
                                        <div class="notification-content">
                                            <p>You have a notification.</p>
                                            <small>2 hours ago</small>
                                ...
                                <li>
                                    <a href="#">
                                        <div class="list-img">
                                            <img src="/admin/images/comment3.jpg" alt="">
                                        </div>
                                        <div class="notification-content">
                                            <p>You have a notification.</p>
                                            <small>2 hours ago</small>
                        ...
                        <div class="dropdown-menu notification-menu">
                            ...
                            <ul>
                                <li>
                                    <a href="#">
                                        <div class="list-img">
                                            <img src="/admin/images/comment4.jpg" alt="">
                                        </div>
                                        <div class="notification-content">
                                            <p>You have a notification.</p>
                                            <small>2 hours ago</small>
                                ...
                                <li>
                                    <a href="#">
                                        <div class="list-img">
                                            <img src="/admin/images/comment5.jpg" alt="">
                                        </div>
                                        <div class="notification-content">
                                            <p>You have a notification.</p>
                                            <small>2 hours ago</small>
                                ...
                                <li>
                                    <a href="#">
                                        <div class="list-img">
                                            <img src="/admin/images/comment6.jpg" alt="">
                                        </div>
                                        <div class="notification-content">
                                            <p>You have a notification.</p>
                                            <small>2 hours ago</small>
            ...
            <div class="copyrights">
                Copyright © 2021 Crocus. All rights reserveds.
            </div>
        </div>
        <!-- Dashboard / End -->
    </div>
    ...
    <script src="/admin/js/counterup.min.js"></script>
    <script src="/admin/js/jquery.slicknav.js"></script>
    <script src="/admin/js/dashboard-custom.js"></script>
</body>
